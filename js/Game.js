    ...
    if(allPlayers !== undefined){
      ...
      for(var plr in allPlayers){
        ...
        ellipse(x,y,100,80);
          ...
          if(frameCount % 20 === 0 && keyIsDown(UP_ARROW)) {
            var obstacle = createSprite(60,100,50,50);
            obstacle.addImage(coinpng);
            obstacle.scale=0.2;
            obstacle.x = cars[index-1].x-200;
            obstacle.y=cars[index-1].y+50;
            }
